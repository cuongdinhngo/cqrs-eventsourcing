 ...
 */
class LoginMinkContext extends MinkContext implements Context, SnippetAcceptingContext
{
    ...
    {
        $response = $this->visitPath("/home");
        dump($response);
        // PHPUnit::assertEquals(200, $response->getStatusCode());
        // $this->content = $response->getContent();
        // PHPUnit::assertStringContainsString($text, $this->content);
    }
}
